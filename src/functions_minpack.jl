...
function minpack(prob, beta0, result; maxiter=100, objscale, kwargs...)
    ...
    opt = MINPACK.fsolve(f!, g!, beta0, show_trace=true, method=:lm, ftol=1e-6, xtol=1e-6, iterations=maxiter)
