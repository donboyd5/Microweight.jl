...
function rwshow_iter(; iter_calc, fcalls, totseconds, objval, targ_rmse,  targ_max, targ_ptile)
    ...
    # display results
    @printf(" %8i %8i %11.3g %12.6g %12.4g %12.4g %12.4g \n",
    iter_calc, fcalls, totseconds, objval, targ_rmse, targ_max, targ_ptile)
    return
end
