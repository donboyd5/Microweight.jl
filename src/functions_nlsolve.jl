...
function newttr_nlsolve(prob, beta0, result; maxiter=100, objscale, kwargs...)
    ...
    opt = NLsolve.nlsolve(f, beta0, autodiff=:forward, autoscale=true, method = :trust_region, iterations=maxiter, show_trace = true)
    # defaults
